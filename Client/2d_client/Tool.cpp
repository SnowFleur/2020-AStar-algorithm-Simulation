...
void CTool::Update() {
    ...
    if (pimpl_->tools_[TOOL_INDEX_MOUSE]->CollisionByMouse(x, y) == true) {
        ...
        CMouseController::SetCurrentTool(CURRENT_TOOL::CURRENT_TOOL_MOUSE);
#ifdef _DEBUG
        ...
        pimpl_->selectTexture_->SetTexturePosition(x, y);
        CMouseController::SetCurrentTool(CURRENT_TOOL::CURRENT_TOOL_WALL);
#ifdef _DEBUG
        ...
        pimpl_->selectTexture_->SetTexturePosition(x, y);
        CMouseController::SetCurrentTool(CURRENT_TOOL::CURRENT_TOOL_CHEESE);
#ifdef _DEBUG
        ...
        pimpl_->selectTexture_->SetTexturePosition(x, y);
        CMouseController::SetCurrentTool(CURRENT_TOOL::CURRENT_TOOL_RESET);
#ifdef _DEBUG
